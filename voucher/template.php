...
if($mks ) { $mks = "border:none; width: 210px; height:140px; background: url('../img/logo4.png') no-repeat; background-size:contain;";}
else{ $mks = "border:none; width: 210px; height:140px; background: 
url('../img/logo4.png') no-repeat; background-size:contain;";}?> 	
